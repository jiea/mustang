    ...
    $.extend($.fn.tabs.methods, {   
        ...
        loadTabIframe:function(jq,params){   
            return jq.each(function(){   
                ...
                var $maskMessage = $('<div class="mask-message" style="z-index:3;width:auto;height:16px;line-height:16px;position:absolute;top:50%;left:50%;margin-top:-20px;margin-left:-92px;border:2px solid #d4d4d4;padding: 12px 5px 10px 30px;background: #ffffff url(\'static/js/jquery-easyui-1.5/themes/icons/loading.gif\') no-repeat scroll 5px center;">' + (params.iframe.message || '正在处理，请稍待。。。') + '</div>').appendTo($tabBody);   
